...
@Service
public class OrderItemService implements OrderItemDTO {
    ...
    @Override
    public List<OrderItem> getOrderItemsForJasperReport() {
    ...
    @Override
    public List<OrderItem> getOrderItemsForJasperReportLimit10() {
        String sql = "SELECT oi.oi_id , REPLACE(CONCAT('http://www.thitikorn-nupan.com/app/', oi.image_url ) , 'images', 'image-ecomerce')  AS image_url , oi.quantity , oi.price \n" +
                "FROM ecomerce_backend_modify.order_items AS oi\n" +
    ...
    @Override
    public List<OrderItem> getOrderItemsForJasperReportWhereLikeDatetime(String datetime) {
        String sql = "SELECT oi.oi_id , REPLACE(CONCAT('http://www.thitikorn-nupan.com/app/', oi.image_url ) , 'images', 'image-ecomerce')  AS image_url , oi.quantity , oi.price ,\n" +
